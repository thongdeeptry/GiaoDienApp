    ...
    return (
        ...
        <View style={styles.container}>
           ...
           <View style={{position:'relative',width:'100%',height:'75%',marginTop:'10%',backgroundColor:'#ffffff',borderTopEndRadius:30,borderTopLeftRadius:30}}>
                ...
                <Text style={{top:28,left:28,fontSize:16,color:'#898A8D',fontWeight:'400'}}>Đăng nhập để tiếp tục</Text></View>
                <View style={styles.khunghinh}>
            <View style={styles.khung}>
            <TextInput style={{fontSize:20}} value={email} onChangeText={setemail} placeholder='Email hoặc Số điện thoại'  multiline={true} maxLength={100}>
        
        </TextInput>
            </View>
            <View style={styles.khung1}>
            <TextInput style={{fontSize:20}} value={password} onChangeText={setpassword} placeholder='Mật khẩu'  multiline={true} maxLength={100}>
        ...
        <View style={{paddingTop:5}}>
            <Text onPress={() =>navigation.navigate('LoginPhone')} style={{color:'#FD397F',fontWeight:'400'}}>Đăng nhập bằng số điện thoại</Text>
        </View>
        </View>
        ...
        <View style={styles.mailnut1}>
            <Pressable style ={styles.nut1} onPress={() =>navigation.navigate('Landing4')}>
