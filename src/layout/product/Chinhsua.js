...
const Chinhsua = (props) => {
  ...
  const updateProfile=()=>{
    if(repassword==password){
      if(email==""||diachi==""||gioitinh==""||ngaysinh==""||nghenghiep==""||name==""){
  ...
  return (
   ...
   width:"100%",}}>
      ...
      <Modal
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={styles.modalText}>Vui lòng xác minh mật khẩu để thay đổi!</Text>
            <TextInput style={styles.veryPass} placeholder="Nhập mật khẩu" 
    ...
    <View style ={ styles.tieude}>
      ...
      <TouchableOpacity style={styles.back} onPress={()=>navigation.navigator("Profile")}>
      ...
      <Image style={styles.avt} source={{uri:avt}}/>
        ...
        <TextInput style={styles.ten} value={name} onChangeText={setname}></TextInput>
   ...
   <View >
    <View style={styles.con}>
      ...
      <TextInput style={styles.w}  placeholder="bao@gmail.com" value={email} onChangeText={setemail}> 
      </TextInput> 
      <TouchableOpacity>
   ...
   <View style={{top:10}} >
    <View style={styles.con}>
      ...
      <TextInput style={styles.w}  placeholder="Nam"  value={diachi} onChangeText={setdiachi}>
   ...
   <View style={{top:20}} >
    <View style={styles.con}>
      ...
      <TextInput style={styles.w}  placeholder="XXXXX"  value={nghenghiep}  onChangeText={setnghenghiep}>
      </TextInput>
      <TouchableOpacity>
      <Image style={styles.edit} source={require("../../image/edit.png")}/>
      </TouchableOpacity>
   ...
   <View style={{top:30}} >
    <View style={styles.con}>
      ...
      <TextInput style={styles.w} placeholder="03/12/2002"  value={ngaysinh} onChangeText={setngaysinh}>
      </TextInput>
      <TouchableOpacity>
      <Image style={styles.edit} source={require("../../image/edit.png")}/>
      </TouchableOpacity>
   ...
   <View style={{top:40}} >
    <View style={styles.con}>
      ...
      <TextInput style={styles.w} placeholder="Nam"  value={gioitinh} onChangeText={setgioitinh}>
      </TextInput>
      <TouchableOpacity>
      <Image style={styles.edit} source={require("../../image/edit.png")}/>
      </TouchableOpacity>
