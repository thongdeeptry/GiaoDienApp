...
// import { Text, StyleSheet, Button, View ,PermissionsAndroid} from 'react-native';
...
//           <Button title="Tắt" onPress={onBackPress} />
//         </View>
//         <View styles={styles.buttonContainer} >
//           {!localStream && <Button title='Tham Gia' onPress={startLocalStream} />}
//           {localStream && <Button title='Bắt Đầu' onPress={() => startCall(roomId)} disabled={!!remoteStream} />}
//         </View>
//       </View>

//       {localStream && (
//         <View style={styles.toggleButtons}>
//           <Button title='Đổi Cam' onPress={switchCamera} />
